...
2. 将所有可枚举属性的值从一个或多个源对象复制到目标对象

3. 如果目标对象中的属性具有相同的键，则属性将被源中的属性覆盖

4. 深拷贝问题：Object.assign()拷贝的是属性值，即源对象指向对象的引用，它也指向相同引用
...
6. ES6的`...`类似于此，`const copy = {...obj}`等价于`Object.assign(copy,obj)`
...
2. Object.assign()内部使用=操作符来赋值，不能复制对象特性（如writable）

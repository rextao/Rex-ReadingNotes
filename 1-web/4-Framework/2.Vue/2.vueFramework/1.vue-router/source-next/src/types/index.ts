...
// TO: find a better way to type readonly types. Readonly<T> is non recursive, maybe we should use it at multiple places. It would also allow preventing the problem Immutable create.
...
// TO: could this be moved to matcher?
/**
...
// TO: should probably be the other way around: RouteLocationNormalized extending from MatcherLocation
...
export interface NavigationGuard {
  (
    // TO: we could maybe add extra information like replace: true/false
...
export interface NavigationHookAfter {
  (
    to: RouteLocationNormalized,
    from: RouteLocationNormalized,
    // TO: move these types to a different file
